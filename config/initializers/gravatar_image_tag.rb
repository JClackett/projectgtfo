GravatarImageTag.configure do |config|
  config.default_image           = 'http://www.theaccessgroup.com/images/box-circle-dark-blue.png'   # Set this to use your own default gravatar image rather then serving up Gravatar's default image [ 'http://example.com/images/default_gravitar.jpg', :identicon, :monsterid, :wavatar, 404 ].
